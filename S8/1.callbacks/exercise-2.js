...
// valor del confirm. La función promptExample hará lo mismo pero con un prompt. La 
// función father recibirá como parámetros description, con el valor del titulo de 
// las ventanas y una función callback (confirmExample o promptExample).

// La función father deberá ejecutar la función que reciba como callback y añadir el 
// valor resultado que retorne la función al array userAnwsers.
